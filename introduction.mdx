...
Available Targets:
  ...
  install-arm        - Install and set up the Docker environment
...
- http://localhost:8888 or http://localhost:8888/dashboard -> dashboard (UI to do the same)
